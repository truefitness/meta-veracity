...
#"
ARCHIVE_VIDEO = "cedarview-vaapi-v1.0.1_bee.tar"
ARCHIVE_PVR = "cedarview-userspace-v1.0.1_bee.tar"

SRC_URI = "file://cedarview-vaapi-v1.0.1_bee.tar;name=psbrpm \
	   file://cedarview-userspace-v1.0.1_bee.tar;name=pvrrpm \
	   file://repo.meego.com/MeeGo/updates/1.2.0/repos/oss/ia32/packages/libwsbm-cdv-1.1.0-3.1.i586.rpm;name=wsbmrpm \
		"
